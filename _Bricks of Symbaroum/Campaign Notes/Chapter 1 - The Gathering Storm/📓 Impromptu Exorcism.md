...
synopsis: Trobela and the party conduct an exorcism to free Smellia from possession
year: 22
month: 1
---
```ad-done
...
> [!example] Quests
> [[📜 Find the missing Templars]], [[📜 Get Aida-Eol back home]]

[[Khargon Tarzibczie|Khargon]] returns to the [[The River Maiden]] to heal, and decides to stay with the elves as they journey north.
